...
export const Corporate = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setCorporateProducts(shuffleArray(data));
      } catch (error) {
  ...
  return (
    <>
      ...
      <Box
        maxWidth="xl"
        className="mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 justify-items-center gap-y-20 gap-x-14 mt-2 mb-5"
      >
