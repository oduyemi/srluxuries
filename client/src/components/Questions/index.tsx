...
export const Questions: React.FC = () => {
    ...
    return(
        <>
            <section className="w-2/3 mb-5 mx-auto">
                <div className="abt-desc mx-auto">
                    <h6 className='font-extrabold my-2 text-tan'>faqs</h6>
                    <h2 className='text-5xl font-extrabold mb-2 text-butter w-1/3'>Your<span><h2 className="pl-2 text-[#39A9DB] inline">Questions</h2></span></h2>
                    <p className="text-sm pl-2 text-brownie">
                        Here are the things you need to know.
                    </p>
                </div> 
                <div className="rounded-t-lg border border-tan bg-butter text-brownie">
                <h2 className="mb-0">
                    <button
        ...
        >
                ...
                <div className="border border-t-0 border-neutral-200 bg-butter text-brownie">
                    <h2 className="mb-0">
                ...
                <div className="rounded-b-lg border border-t-0 border-neutral-200 bg-butter text-brownie">
