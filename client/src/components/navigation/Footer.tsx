    ...
    <footer className="relative bg-brownie pt-8 pb-6">
        <div className="container mx-auto px-4">
            ...
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                ...
                <Link href="https://www.creative-tim.com/product/notus-js" className="text-blueGray-500 hover:text-gray-800" target="_blank"> Notus JS by
                <Link href="https://www.creative-tim.com?ref=njs-profile" className="text-blueGray-500 hover:text-blueGray-800">Creative Tim</Link>.
                </div>
            </div>
            </div>
        </div>
