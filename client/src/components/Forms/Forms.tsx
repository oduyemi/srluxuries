...
export const LoginForm = () => {
    return(
        <Box className="my-5">
        <Box className="form login bg-transparent border-butter w-1/4 border border-2 border-rounded mx-auto">
            <Box className="w-full mx-auto">
                <form className="mt-5 pl-4">
                    <Box className="form-header text-center my-3">
...
export const Reg1 = () => {
    return(
        <Box className="my-5">
            <Box className="form bg-transparent border-butter w-1/4 border border-2 border-rounded mx-auto">
                <Box className="w-full mx-auto">
                    <form className="mt-5 pl-4">
                        <Box className="form-header text-center">
...
export const Reg5 = () => {
    return(
        <Box className="my-5">
            <Box className="form form-suit bg-transparent border-butter w-1/4 border border-2 border-rounded mx-auto">
                <Box className="w-full mx-auto">
                    <form className="mt-5 pl-4">
                        <Box className="form-header text-center">
...
export const Appointment = () => {
    return(
        <Box className="my-5">
            <Box className="form form-apt bg-transparent border-butter w-1/4 border border-2 border-rounded mx-auto">
                <Box className="w-full mx-auto">
                    <form className="mt-5 pl-4" method="post" action="/">
                        ...
                        <Box data-field-id="1">
                            ...
                            <Box className="mb-3 mt-5" data-field-id="2">
